...
export const CompanySummary = ({companyName, ticker}) => {
    ...
    <div className="company-summary-container">
        <div className="company-long-summary">
            ...
            <p className="company-long-summary-text">{(information && 'longBusinessSummary' in information && information.longBusinessSummary) ? information.longBusinessSummary : 'No summary available'}</p>
        </div>
