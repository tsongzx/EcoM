...
import { getAllMetrics, getOfficialFrameworks } from "../helper.js";
...
const CreateFramework = ({ setOfficialFrameworks, setSelectedFramework }) => {
  ...
  return (
    <div>
      <Button variant="contained" width="100%" sx={{
        width: '100%', margin: '2vh 0', backgroundColor: '#0c3960', fontWeight: 'bold', marginLeft: '5px',
        '&:hover': {
